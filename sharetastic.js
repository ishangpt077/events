            ...
            var defaults = {
                ...
                services: {
                    facebook: {
                        order: 0,
                        name: 'Facebook',
                        href: 'https://www.facebook.com/ishan.jammu/',
                        icon: {
                            width: 32,
                            height: 32,
                    ...
                    instagram: {
                        order: 1,
                        name: 'instagram',
                        href: 'https://www.instagram.com/ishan_jammu/',
                        icon: {
                            width: 32,
                            height: 32,
                    ...
                    whatsapp: {
                        order: 2,
                        name: 'WhatsApp',
                        href: 'https://api.whatsapp.com/send?text=I visit your website and want to discuss about Marriage expenses. &phone=919716412180' + this.page.title + ' - ' + this.page.description + ' ' + this.page.url,
                        icon: {
                            width: 32,
                            height: 32,
